...
또한 u64의 경우 64bit에서 사용하는데, 64bit에서 사용되는 주소는 6 byte만 사용되므로 leak을 하면 6 byte만 출력이 된다. 따라서 `u64(p.recv(6).ljust(8, 'x00'))`과 같이 `ljust`를 함께 사용한다.

*https://docs.pwntools.com/en/stable/util/packing.html*<br>
